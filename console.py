...
sight1 = Sight("Eiffel Tower",city1, False)
sight_repository.save(sight1)
sight2 = Sight("Amoudi Bay", city2, False)
sight_repository.save(sight2)
sight3 = Sight("Town Bridge", city3, False)
sight_repository.save(sight3)
sight4 = Sight("Lake Zurich", city4, False)
sight_repository.save(sight4)
sight5 = Sight("Bellagio Fountains", city5, False)
sight_repository.save(sight5)
sight6 = Sight("Sydney Opera House", city6, False)
sight_repository.save(sight6)
sight7 = Sight("Burj Khalifa", city7, True)
